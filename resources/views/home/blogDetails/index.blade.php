...
<div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset('/')}}img/blog-1.jpg')">
    <div class="container">
        ...
        <div class="col-md-6">
          <div class="post-entry text-center">
            ...
            <div class="post-meta align-items-center text-center">
              <figure class="author-figure mb-0 me-3 d-inline-block"><img src="{{asset('/')}}img/blog-1.jpg" alt="Image" class="img-fluid"></figure>
          ...
          <div class="post-content-body">
            ...
            <div class="row my-4">
              <div class="col-md-12 mb-4">
                <img src="{{asset('/')}}img/blog-1.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
        ...
        <div class="col-md-12 col-lg-4 sidebar">
          ...
          <div class="sidebar-box">
            <div class="bio text-center">
              <img src="{{asset('/')}}img/blog-1.jpg" alt="Image Placeholder" class="img-fluid mb-3">
              <div class="bio-body">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="blog-entry">
            <a href="single.html" class="img-link">
              <img src="{{asset('/')}}img/blog-1.jpg" alt="Image" class="img-fluid">
            </a>
