                    ...
                    <div class="post-content-body">
                        ...
                        <div class="row my-4">
                            <div class="col-md-12 mb-4">
                                <img src="{{ asset($details->image) }}" alt="Image placeholder"
                ...
                <div class="col-md-12 col-lg-4 sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="bio text-center">
                            <img src="{{ asset($details->user->image) }}" alt="Image Placeholder" class="img-fluid mb-3">
                            <div class="bio-body">
                                ...
                                <p><a href="{{route('blogger.profile',['id'=>$details->user_id]) }}" class="btn btn-primary btn-sm rounded px-2 py-2">VIEW PROFILE</a></p>
                                <p class="social">
