            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <ul class="dropdown-menu">
                                @foreach ($categories as $category)
                                    <li><a class="dropdown-item"
                                            href="{{ route('category-wise.blog', ['id' => $category->id]) }}">{{ $category->category_name }}</a>
                                    </li>
                                @endforeach
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                                href="{{ Session::get('user_role') === 'User' ? route('user.dashboard') : (Session::get('user_role') === 'Blogger' ? route('blogger.dashboard') : route('admin.dashboard')) }}">Dashboard</a>
                        </li>
                ...
                <div class="col-12 text-center">
                    ...
                    <p>Copyright &copy;
                        <script>
                            ...
                            class="navbar-brand" href="{{ route('home') }}">
                            <span>Teach</span><span><span class="text-danger">M</span>ag</span>
                        </a>
                    </p>
                </div>
